...
class Base(object):
    ...
    def __init__(self, args, window=None, _sugar=False):
        ...
        actions = [
            ...
            ('addaftercurrentitemmenu', gtk.STOCK_GO_DOWN, _('Add After Current Track'), '<Ctrl><Alt>d', None, self.on_add_after_current_item),
            ('addaftercurrentalbummenu', gtk.STOCK_GOTO_BOTTOM, _('Add After Current Album'), '<Ctrl><Shift>d', None, self.on_add_after_current_album),
